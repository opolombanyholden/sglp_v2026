...
@section('title', 'Créer une Étape de Workflow')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-plus-circle text-primary"></i> Nouvelle Étape de Workflow
            </h1>
            <p class="text-muted mb-0">Créer une nouvelle étape dans le workflow de validation</p>
        </div>
    ...
    <!-- Formulaire -->
    <form action="{{ route('admin.workflow-steps.store') }}" method="POST" id="createStepForm">
        @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                @enderror
                                <small class="form-text text-muted">Lettres majuscules, chiffres et underscores uniquement</small>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       class="form-control @error('numero_passage') is-invalid @enderror" 
                                       id="numero_passage" 
                                       name="numero_passage" 
                                       value="{{ old('numero_passage', 1) }}"
                                       min="1"
                                       required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   name="libelle" 
                                   value="{{ old('libelle') }}"
                                   placeholder="Ex: Réception et vérification initiale"
                                   required
                                   maxlength="255">
                            @error('libelle')
                            <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3"
                                      placeholder="Description détaillée de cette étape et de ses objectifs">{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('type_organisation') is-invalid @enderror" 
                                    ...
                                    <option value="ong" {{ old('type_organisation') == 'ong' ? 'selected' : '' }}>ONG</option>
                                    <option value="parti_politique" {{ old('type_organisation') == 'parti_politique' ? 'selected' : '' }}>Parti Politique</option>
                                    <option value="confession_religieuse" {{ old('type_organisation') == 'confession_religieuse' ? 'selected' : '' }}>Confession Religieuse</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('type_operation') is-invalid @enderror" 
                                        ...
                                        required>
                                    <option value="">-- Sélectionner --</option>
                                    <option value="creation" {{ old('type_operation') == 'creation' ? 'selected' : '' }}>Création</option>
                                    <option value="modification" {{ old('type_operation') == 'modification' ? 'selected' : '' }}>Modification</option>
                                    <option value="cessation" {{ old('type_operation') == 'cessation' ? 'selected' : '' }}>Cessation</option>
                                    <option value="ajout_adherent" {{ old('type_operation') == 'ajout_adherent' ? 'selected' : '' }}>Ajout Adhérent</option>
                                    <option value="retrait_adherent" {{ old('type_operation') == 'retrait_adherent' ? 'selected' : '' }}>Retrait Adhérent</option>
                                    <option value="declaration_activite" {{ old('type_operation') == 'declaration_activite' ? 'selected' : '' }}>Déclaration d'Activité</option>
                                    <option value="changement_statutaire" {{ old('type_operation') == 'changement_statutaire' ? 'selected' : '' }}>Changement Statutaire</option>
                                </select>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="template_document" class="form-label">
                                    ...
                                    <i class="fas fa-info-circle text-muted" 
                                       data-bs-toggle="tooltip" 
                                       title="Nom du template si cette étape génère un document"></i>
                                </label>
                                <input type="text" 
                                       class="form-control @error('template_document') is-invalid @enderror" 
                                       id="template_document" 
                                       name="template_document" 
                                       value="{{ old('template_document') }}"
                                       placeholder="Ex: recepisse.blade.php"
                                       maxlength="255">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" 
                                           type="checkbox" 
                                           id="permet_commentaire" 
                                           name="permet_commentaire" 
                                           value="1"
                                           {{ old('permet_commentaire', true) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" 
                                           type="checkbox" 
                                           id="genere_document" 
                                           name="genere_document" 
                                           value="1"
                                           {{ old('genere_document', false) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control font-monospace @error('champs_requis') is-invalid @enderror" 
                                      ...
                                      name="champs_requis" 
                                      rows="4"
                                      placeholder='["nom_organisation", "adresse_siege", "numero_agrement"]'>{{ old('champs_requis') }}</textarea>
                            @error('champs_requis')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">
                                <i class="fas fa-code"></i> Format JSON valide requis. Laissez vide si aucun champ spécifique.
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow mb-4 border-left-primary">
                    <div class="card-body">
                        ...
                        <ul class="small mb-0">
                            <li class="mb-2">Le <strong>code</strong> doit être unique en majuscules</li>
                            <li class="mb-2">Le <strong>numéro de passage</strong> détermine l'ordre</li>
                            <li class="mb-2">Le <strong>type d'organisation</strong> et <strong>type d'opération</strong> définissent le contexte</li>
                            <li class="mb-2">Le <strong>délai de traitement</strong> est en heures (48h = 2 jours)</li>
                            <li>Les <strong>champs requis</strong> doivent être en format JSON valide</li>
                        </ul>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#createStepForm').on('submit', function(e) {
        const code = $('#code').val();
    ...
    // Auto-suggestion pour template_document
    $('#genere_document').on('change', function() {
        if ($(this).is(':checked') && !$('#template_document').val()) {
            const typeOrg = $('#type_organisation').val();
            const typeOp = $('#type_operation').val();
            if (typeOrg && typeOp) {
                const suggestion = `${typeOrg}_${typeOp}.blade.php`;
                $('#template_document').attr('placeholder', `Ex: ${suggestion}`);
            }
        }
    });
});
