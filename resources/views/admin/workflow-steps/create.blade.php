                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" id="code"
                                        name="code" value="{{ old('code') }}" placeholder="STEP_RECEPTION" required
                                        maxlength="255" pattern="[A-Z0-9_]+" style="text-transform: uppercase;">
                                    @error('code')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('numero_passage') is-invalid @enderror"
                                        id="numero_passage" name="numero_passage" value="{{ old('numero_passage', 1) }}"
                                        min="1" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('type_organisation') is-invalid @enderror"
                                        ...
                                        <option value="association"
                                            {{ old('type_organisation') == 'association' ? 'selected' : '' }}>Association
                                        </option>
                                        <option value="ong" {{ old('type_organisation') == 'ong' ? 'selected' : '' }}>ONG
                                        </option>
                                        <option value="parti_politique"
                                            {{ old('type_organisation') == 'parti_politique' ? 'selected' : '' }}>Parti
                                            Politique</option>
                                        <option value="confession_religieuse"
                                            {{ old('type_organisation') == 'confession_religieuse' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('type_operation') is-invalid @enderror"
                                        ...
                                        <option value="creation"
                                            {{ old('type_operation') == 'creation' ? 'selected' : '' }}>Création</option>
                                        <option value="modification"
                                            {{ old('type_operation') == 'modification' ? 'selected' : '' }}>Modification
                                        </option>
                                        <option value="cessation"
                                            {{ old('type_operation') == 'cessation' ? 'selected' : '' }}>Cessation</option>
                                        <option value="ajout_adherent"
                                            {{ old('type_operation') == 'ajout_adherent' ? 'selected' : '' }}>Ajout Adhérent
                                        </option>
                                        <option value="retrait_adherent"
                                            {{ old('type_operation') == 'retrait_adherent' ? 'selected' : '' }}>Retrait
                                            Adhérent</option>
                                        <option value="declaration_activite"
                                            {{ old('type_operation') == 'declaration_activite' ? 'selected' : '' }}>
                                            Déclaration d'Activité</option>
                                        <option value="changement_statutaire"
                                            {{ old('type_operation') == 'changement_statutaire' ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('delai_traitement', 48) }}" min="1" required>
                                    ...
                                    <select class="form-select @error('template_document') is-invalid @enderror"
                                        ...
                                        @foreach($templates as $template)
                                            <option value="{{ $template->code }}"
                                                {{ old('template_document') == $template->code ? 'selected' : '' }}>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="permet_rejet"
                                            name="permet_rejet" value="1" {{ old('permet_rejet', true) ? 'checked' : '' }}>
                    ...
                    <div class="card shadow mb-4 border-left-primary">
                        <div class="card-body">
                            ...
                            <ul class="small mb-0">
                                ...
                                <li class="mb-2">Le <strong>type d'organisation</strong> et <strong>type
                                        d'opération</strong> définissent le contexte</li>
