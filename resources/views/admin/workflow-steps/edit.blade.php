                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="numero_passage" 
                                       name="numero_passage" 
                                       value="{{ old('numero_passage', $step->numero_passage) }}"
                                       min="1"
                                       required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="libelle" 
                                   name="libelle" 
                                   value="{{ old('libelle', $step->libelle) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('type_organisation') is-invalid @enderror" 
                                    ...
                                    <option value="association" {{ old('type_organisation', $step->type_organisation) == 'association' ? 'selected' : '' }}>Association</option>
                                    <option value="ong" {{ old('type_organisation', $step->type_organisation) == 'ong' ? 'selected' : '' }}>ONG</option>
                                    <option value="parti_politique" {{ old('type_organisation', $step->type_organisation) == 'parti_politique' ? 'selected' : '' }}>Parti Politique</option>
                                    <option value="confession_religieuse" {{ old('type_organisation', $step->type_organisation) == 'confession_religieuse' ? 'selected' : '' }}>Confession Religieuse</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('type_operation') is-invalid @enderror" 
                                        ...
                                        required>
                                    <option value="">-- Sélectionner --</option>
                                    <option value="creation" {{ old('type_operation', $step->type_operation) == 'creation' ? 'selected' : '' }}>Création</option>
                                    <option value="modification" {{ old('type_operation', $step->type_operation) == 'modification' ? 'selected' : '' }}>Modification</option>
                                    <option value="cessation" {{ old('type_operation', $step->type_operation) == 'cessation' ? 'selected' : '' }}>Cessation</option>
                                    <option value="ajout_adherent" {{ old('type_operation', $step->type_operation) == 'ajout_adherent' ? 'selected' : '' }}>Ajout Adhérent</option>
                                    <option value="retrait_adherent" {{ old('type_operation', $step->type_operation) == 'retrait_adherent' ? 'selected' : '' }}>Retrait Adhérent</option>
                                    <option value="declaration_activite" {{ old('type_operation', $step->type_operation) == 'declaration_activite' ? 'selected' : '' }}>Déclaration d'Activité</option>
                                    <option value="changement_statutaire" {{ old('type_operation', $step->type_operation) == 'changement_statutaire' ? 'selected' : '' }}>Changement Statutaire</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('delai_traitement', $step->delai_traitement) }}"
                                       min="1"
                                       required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('template_document', $step->template_document) }}"
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow mb-4 border-left-info">
                    <div class="card-body">
                        ...
                        <ul class="small mb-0">
                            ...
                            <li><strong>Délai moyen :</strong> {{ $stats->delai_moyen ? round($stats->delai_moyen, 1) . 'h' : 'N/A' }}</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card shadow mb-4 border-left-primary">
                    <div class="card-body">
                        ...
                        <ul class="small mb-0">
                            <li class="mb-2">Attention : modifier le <strong>code</strong> peut affecter les références existantes</li>
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.workflow-steps.show', $step->id) }}" class="btn btn-info btn-block w-100 mb-2">
                            <i class="fas fa-eye"></i> Voir Détails
                        </a>
