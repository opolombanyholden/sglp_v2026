                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" id="code"
                                        name="code" value="{{ old('code') }}" maxlength="15"
                                        placeholder="Ex: EST01, WOL02..." style="text-transform: uppercase;">
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('chef_lieu') is-invalid @enderror"
                                        id="chef_lieu" name="chef_lieu" value="{{ old('chef_lieu') }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                        ...
                                        placeholder="Description du département, ses caractéristiques, son histoire...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('superficie_km2') is-invalid @enderror"
                                        id="superficie_km2" name="superficie_km2" value="{{ old('superficie_km2') }}"
                                        min="0" max="999999.99" step="0.01" placeholder="Ex: 15000">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number"
                                        ...
                                        id="population_estimee" name="population_estimee"
                                        value="{{ old('population_estimee') }}" min="0" max="99999999"
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('ordre_affichage', 0) }}" min="0" max="999">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('latitude') is-invalid @enderror"
                                        ...
                                        step="0.00000001" placeholder="Ex: 0.3901">
                                    @error('latitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('longitude') is-invalid @enderror"
                                        ...
                                        step="0.00000001" placeholder="Ex: 9.4544">
                                    @error('longitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
