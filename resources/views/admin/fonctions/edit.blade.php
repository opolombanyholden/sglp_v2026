...
@section('title', 'Modifier Fonction')
@section('page-title', 'Modifier une Fonction')
            ...
            <div class="card form-card">
                <div class="form-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-1"><i class="fas fa-edit mr-2"></i>Modifier la Fonction</h4>
                            <small class="opacity-75">{{ $fonction->nom }}</small>
                        </div>
                ...
                <form action="{{ route('admin.referentiels.fonctions.update', $fonction) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body p-4">
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="nom_feminin" class="form-control @error('nom_feminin') is-invalid @enderror" 
                                           value="{{ old('nom_feminin', $fonction->nom_feminin) }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" 
                                           value="{{ old('code', $fonction->code) }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="categorie" class="form-control @error('categorie') is-invalid @enderror" required>
                                        @foreach($categories as $key => $label)
                                            <option value="{{ $key }}" {{ old('categorie', $fonction->categorie) == $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                                          rows="2">{{ old('description', $fonction->description) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="ordre" class="form-control @error('ordre') is-invalid @enderror" 
                                           value="{{ old('ordre', $fonction->ordre) }}" min="0" required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="nb_max" class="form-control @error('nb_max') is-invalid @enderror" 
                                           value="{{ old('nb_max', $fonction->nb_max) }}" min="1" max="999" required>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="is_bureau" name="is_bureau" value="1" 
                                               {{ old('is_bureau', $fonction->is_bureau) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="is_obligatoire" name="is_obligatoire" value="1" 
                                               {{ old('is_obligatoire', $fonction->is_obligatoire) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="is_unique" name="is_unique" value="1" 
                                               {{ old('is_unique', $fonction->is_unique) ? 'checked' : '' }}>
                        ...
                        <div class="form-section">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        @foreach($icones as $icon => $label)
                                            <div class="icon-option {{ old('icone', $fonction->icone) == $icon ? 'selected' : '' }}" 
                                                 data-icon="{{ $icon }}" title="{{ $label }}">
                                                <i class="fas {{ $icon }}"></i>
                                            </div>
                                        @endforeach
                                    </div>
                                    <input type="hidden" name="icone" id="icone" value="{{ old('icone', $fonction->icone) }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label font-weight-bold">Couleur</label>
                                    <div class="d-flex flex-wrap gap-2">
                                        @foreach($couleurs as $hex => $label)
                                            <div class="color-option {{ old('couleur', $fonction->couleur) == $hex ? 'selected' : '' }}" 
                                                 style="background-color: {{ $hex }};" 
                                                 data-color="{{ $hex }}" title="{{ $label }}">
                                            </div>
                                        @endforeach
                                    </div>
                                    <input type="hidden" name="couleur" id="couleur" value="{{ old('couleur', $fonction->couleur) }}">
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div>
                                    <span class="preview-badge" id="previewBadge" style="background-color: {{ old('couleur', $fonction->couleur ?? '#009e3f') }}; color: white;">
                                        <i class="fas {{ old('icone', $fonction->icone ?? 'fa-user') }} mr-2" id="previewIcon"></i>
                                        <span id="previewNom">{{ old('nom', $fonction->nom) }}</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" 
                                       {{ old('is_active', $fonction->is_active) ? 'checked' : '' }}>
