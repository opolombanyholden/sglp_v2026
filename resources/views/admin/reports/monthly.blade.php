...
@section('title', $title ?? 'Rapport Mensuel')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Rapport Mensuel</li>
@endsection
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="fas fa-calendar-alt"></i> {{ $title ?? 'Rapport Mensuel' }}</h2>
                    <div>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-info text-white">
                        <h5 class="mb-0"><i class="fas fa-filter"></i> Sélection de la période</h5>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-0">Nouveaux utilisateurs ce mois</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-secondary text-white">
                                <h5 class="mb-0"><i class="fas fa-chart-line"></i> Statistiques Globales</h5>
                            </div>
                            <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="btn-group" role="group">
                            <a href="{{ route('admin.exports.index') }}?type=monthly&month={{ $month }}&year={{ $year }}"
                                class="btn btn-success">
                                <i class="fas fa-file-excel"></i> Excel
                            </a>
                            <a href="{{ route('admin.exports.index') }}?type=monthly&month={{ $month }}&year={{ $year }}&format=pdf"
                                class="btn btn-danger">
                                <i class="fas fa-file-pdf"></i> PDF
                            </a>
                            <a href="{{ route('admin.exports.index') }}?type=monthly&month={{ $month }}&year={{ $year }}&format=csv"
                                class="btn btn-info">
