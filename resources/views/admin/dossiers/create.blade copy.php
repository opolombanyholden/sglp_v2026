                                    ...
                                    <div class="form-grid">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select-modern" name="org_province_id" id="org_province_id" required>
                                                ...
                                                <option value="{{ $province->id }}" {{ old('org_province_id') == $province->id ? 'selected' : '' }}>{{ $province->nom }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label-modern">Commune</label>
                                        ...
                                        <div class="form-group span-2">
                                            ...
                                            <input type="text" class="form-input-modern" name="org_adresse" id="org_adresse" value="{{ old('org_adresse') }}" required placeholder="Quartier, rue, bâtiment...">
                                        </div>
                                        <div class="form-group">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('org_province_id').addEventListener('change', function() {
        ...
        // Remplir le champ caché avec le nom textuel
        document.getElementById('province_nom').value = selectedOption.text || '';
        ...
        dept.innerHTML = '<option value="">Chargement...</option>';
        dept.disabled = true;
        com.innerHTML = '<option value="">(Optionnel)</option>';
        com.disabled = true;
        arr.innerHTML = '<option value="">(Optionnel)</option>';
        arr.disabled = true;
            ...
            fetch('{{ url("admin/api/geo/departements") }}/' + id)
                ...
                .then(function(data) {
                    if (data.success) {
                        ...
                        data.data.forEach(function(d) { html += '<option value="' + d.id + '" data-nom="' + d.nom + '">' + d.nom + '</option>'; });
                        dept.innerHTML = html;
                        dept.disabled = false;
                    }
                });
    ...
    // Cascade géographique - Département
    document.getElementById('org_departement_id').addEventListener('change', function() {
        ...
        // Remplir le champ caché avec le nom textuel
        document.getElementById('departement_nom').value = selectedOption.text || '';
        document.getElementById('commune_nom').value = '';
        document.getElementById('arrondissement_text').value = '';
        
        com.innerHTML = '<option value="">Chargement...</option>';
        arr.innerHTML = '<option value="">(Optionnel)</option>';
        arr.disabled = true;
        
        if (id) {
            fetch('{{ url("admin/api/geo/communes") }}/' + id)
                .then(function(r) { return r.json(); })
                .then(function(data) {
                    if (data.success) {
    ...
    document.getElementById('org_commune_id').addEventListener('change', function() {
        ...
        // Remplir le champ caché avec le nom textuel
        document.getElementById('commune_nom').value = selectedOption.text || '';
        document.getElementById('arrondissement_text').value = '';
    ...
    // Cascade géographique - Arrondissement
    document.getElementById('org_arrondissement_id').addEventListener('change', function() {
        var selectedOption = this.options[this.selectedIndex];
        // Remplir le champ caché avec le nom textuel
        document.getElementById('arrondissement_text').value = selectedOption.text || '';
    });
