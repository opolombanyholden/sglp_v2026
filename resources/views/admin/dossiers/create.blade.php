                                                ...
                                                <select class="form-select-modern" name="org_domaine_activite_id"
                                                    ...
                                                    @foreach($domainesActivite as $domaine)
                                                        <option value="{{ $domaine->id }}"
                                                            {{ old('org_domaine_activite_id') == $domaine->id ? 'selected' : '' }}>
                                                            {{ $domaine->nom }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="accordion-content">
                                        ...
                                        <div class="section-footer final">
                                            ...
                                            <div class="d-flex gap-2 flex-wrap">
                                                ...
                                                <button type="button" class="btn-draft" id="btnSaveDraft"
                                                    onclick="submitFormWithAction('brouillon')">
                                                    <i class="fas fa-save"></i>
                                                    <span>Enregistrer Brouillon</span>
                                                </button>
                                                <!-- Bouton Soumettre -->
                                                <button type="button" class="btn-submit" id="btnSubmitForm"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            window.submitFormWithAction = function (action) {
                ...
                document.getElementById('createDossierForm').submit();
            };
