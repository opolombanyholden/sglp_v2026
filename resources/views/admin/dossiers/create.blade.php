    ...
    <div class="container-fluid py-4">
        ...
        <div class="stepper-container">
            <div class="stepper">
                ...
                <div class="step" data-step="6" onclick="goToSection('collapseAdherents')">
                    <div class="step-number">6</div>
                    <div class="step-label">Adhérents</div>
                </div>
                <div class="step" data-step="7" onclick="goToSection('collapseDocuments')">
        ...
        <form id="createDossierForm" method="POST" action="{{ route('admin.dossiers.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="accordion accordion-modern" id="accordionDossier">
                        ...
                        <div class="accordion-item" id="itemType">
                            <div class="accordion-header">
                                <button class="accordion-trigger" type="button" data-bs-toggle="collapse" data-bs-target="#collapseType" aria-expanded="true">
                                    <div class="accordion-trigger-content">
                                        <div class="step-icon-box green"><i class="fas fa-building"></i></div>
                                        <div class="step-text-group">
                                            <div class="step-eyebrow">Étape 1 sur 7</div>
                            ...
                            <div id="collapseType" class="accordion-collapse collapse show" data-bs-parent="#accordionDossier">
                                <div class="accordion-content">
                                    <div class="type-selection-grid">
                                        ...
                                        <label class="type-option" id="typeCard{{ $type->id }}">
                                            ...
                                            <div class="type-card-inner">
                                                <div class="type-icon-wrapper" style="background: linear-gradient(135deg, {{ $type->couleur ?? '#009e3f' }}, {{ $type->couleur ?? '#00c44f' }}dd);">
                                                    <i class="fas {{ $type->icone ?? 'fa-building' }}"></i>
                                                </div>
                                                <div class="type-title">{{ $type->nom }}</div>
                                                <div class="type-details">
                                                    <span>Min. {{ $type->nb_min_fondateurs_majeurs ?? 2 }} fondateurs</span>
                                    ...
                                    <div class="section-footer">
                                        <div></div>
                                        <button type="button" class="btn-nav btn-nav-next" onclick="goToSection('collapseDeclarant')">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header">
                                <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDeclarant" aria-expanded="false">
                                    <div class="accordion-trigger-content">
                                        <div class="step-icon-box yellow"><i class="fas fa-user-tie"></i></div>
                                        <div class="step-text-group">
                                            <div class="step-eyebrow">Étape 2 sur 7</div>
                            ...
                            <div id="collapseDeclarant" class="accordion-collapse collapse" data-bs-parent="#accordionDossier">
                                <div class="accordion-content">
                                    <div class="form-grid">
                                        <div class="form-group">
                                            <label class="form-label-modern">NIP <span class="required">*</span></label>
                                            <input type="text" class="form-input-modern" name="demandeur_nip" id="demandeur_nip" value="{{ old('demandeur_nip') }}" required placeholder="Numéro d'identification">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label-modern">Civilité</label>
                                            <select class="form-select-modern" name="demandeur_civilite" id="demandeur_civilite">
                                                <option value="M" {{ old('demandeur_civilite') == 'M' ? 'selected' : '' }}>Monsieur</option>
                                                <option value="Mme" {{ old('demandeur_civilite') == 'Mme' ? 'selected' : '' }}>Madame</option>
                                                <option value="Mlle" {{ old('demandeur_civilite') == 'Mlle' ? 'selected' : '' }}>Mademoiselle</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label-modern">Nom <span class="required">*</span></label>
                                            <input type="text" class="form-input-modern" name="demandeur_nom" id="demandeur_nom" value="{{ old('demandeur_nom') }}" required placeholder="Nom de famille">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label-modern">Prénom <span class="required">*</span></label>
                                            <input type="text" class="form-input-modern" name="demandeur_prenom" id="demandeur_prenom" value="{{ old('demandeur_prenom') }}" required placeholder="Prénom">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label-modern">Téléphone <span class="required">*</span></label>
                                            <input type="tel" class="form-input-modern" name="demandeur_telephone" id="demandeur_telephone" value="{{ old('demandeur_telephone') }}" required placeholder="+241 XX XX XX XX">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label-modern">Email</label>
                                            <input type="email" class="form-input-modern" name="demandeur_email" id="demandeur_email" value="{{ old('demandeur_email') }}" placeholder="email@exemple.com">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label-modern">Fonction/Rôle</label>
                                            <select class="form-select-modern" name="demandeur_role" id="demandeur_role">
                                    ...
                                    <div class="section-footer">
                                        <button type="button" class="btn-nav btn-nav-prev" onclick="goToSection('collapseType')">
                                            <i class="fas fa-arrow-left"></i> Précédent
                                        </button>
                                        <button type="button" class="btn-nav btn-nav-next" onclick="goToSection('collapseOrganisation')">
                                            Suivant <i class="fas fa-arrow-right"></i>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header">
                                <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOrganisation" aria-expanded="false">
                                    <div class="accordion-trigger-content">
                                        <div class="step-icon-box blue"><i class="fas fa-landmark"></i></div>
                                        <div class="step-text-group">
                                            <div class="step-eyebrow">Étape 3 sur 7</div>
                            ...
                            <div id="collapseOrganisation" class="accordion-collapse collapse" data-bs-parent="#accordionDossier">
                                <div class="accordion-content">
                                    <div class="form-grid">
                                        <div class="form-group span-2">
                                            <label class="form-label-modern">Nom de l'organisation <span class="required">*</span></label>
                                            <input type="text" class="form-input-modern" name="org_nom" id="org_nom" value="{{ old('org_nom') }}" required placeholder="Dénomination officielle">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label-modern">Sigle / Acronyme</label>
                                            <input type="text" class="form-input-modern" name="org_sigle" id="org_sigle" value="{{ old('org_sigle') }}" placeholder="Ex: ASBL, ONG...">
                                        </div>
                                        <div class="form-group span-3">
                                            <label class="form-label-modern">Objet social <span class="required">*</span></label>
                                            <textarea class="form-textarea-modern" name="org_objet" id="org_objet" rows="3" required placeholder="Description des activités et objectifs...">{{ old('org_objet') }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label-modern">Date de création <span class="required">*</span></label>
                                            <input type="date" class="form-input-modern" name="org_date_creation" id="org_date_creation" value="{{ old('org_date_creation') }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label-modern">Téléphone <span class="required">*</span></label>
                                            <input type="tel" class="form-input-modern" name="org_telephone" id="org_telephone" value="{{ old('org_telephone') }}" required placeholder="+241 XX XX XX XX">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label-modern">Email</label>
                                            <input type="email" class="form-input-modern" name="org_email" id="org_email" value="{{ old('org_email') }}" placeholder="contact@organisation.ga">
                                        </div>
                                    </div>
                                    
                                    <div class="section-footer">
                                        <button type="button" class="btn-nav btn-nav-prev" onclick="goToSection('collapseDeclarant')">
                                            <i class="fas fa-arrow-left"></i> Précédent
                                        </button>
                                        <button type="button" class="btn-nav btn-nav-next" onclick="goToSection('collapseLocalisation')">
                                            Suivant <i class="fas fa-arrow-right"></i>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header">
                                <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseLocalisation" aria-expanded="false">
                                    <div class="accordion-trigger-content">
                                        <div class="step-icon-box purple"><i class="fas fa-map-marker-alt"></i></div>
                                        <div class="step-text-group">
                                            <div class="step-eyebrow">Étape 4 sur 7</div>
                            ...
                            <div id="collapseLocalisation" class="accordion-collapse collapse" data-bs-parent="#accordionDossier">
                                <div class="accordion-content">
                                    ...
                                    <div class="zone-selector mb-4">
                                        <label class="form-label-modern">Type de zone <span class="required">*</span></label>
                                        <div class="zone-options">
                                            <label class="zone-option">
                                                <input type="radio" name="zone_type" value="urbaine" {{ old('zone_type', 'urbaine') == 'urbaine' ? 'checked' : '' }}>
                                                <div class="zone-card">
                                            ...
                                            <label class="zone-option">
                                                <input type="radio" name="zone_type" value="rurale" {{ old('zone_type') == 'rurale' ? 'checked' : '' }}>
                                                <div class="zone-card">
                                    ...
                                    <div class="form-grid">
                                        <!-- Province (commun) -->
                                        <div class="form-group">
                                            <label class="form-label-modern">Province <span class="required">*</span></label>
                                            <select class="form-select-modern" name="org_province_id" id="org_province_id" required>
                                                <option value="">Sélectionner une province...</option>
                                                @foreach($provinces as $province)
                                                <option value="{{ $province->id }}" data-nom="{{ $province->nom }}" {{ old('org_province_id') == $province->id ? 'selected' : '' }}>{{ $province->nom }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <!-- Département (commun) -->
                                        <div class="form-group">
                                            <label class="form-label-modern">Département <span class="required">*</span></label>
                                            <select class="form-select-modern" name="org_departement_id" id="org_departement_id" required disabled>
                                        ...
                                        <div class="form-group zone-urbaine-field">
                                            ...
                                            <select class="form-select-modern" name="org_commune_id" id="org_commune_id" disabled>
                                        ...
                                        <div class="form-group zone-urbaine-field">
                                            ...
                                            <select class="form-select-modern" name="org_arrondissement_id" id="org_arrondissement_id" disabled>
                                        ...
                                        <div class="form-group zone-urbaine-field">
                                            ...
                                            <select class="form-select-modern" name="org_quartier_id" id="org_quartier_id" disabled>
                                        ...
                                        <div class="form-group zone-rurale-field" style="display: none;">
                                            ...
                                            <select class="form-select-modern" name="org_canton_id" id="org_canton_id" disabled>
                                                <option value="">Sélectionner département...</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group zone-rurale-field" style="display: none;">
                                            ...
                                            <select class="form-select-modern" name="org_regroupement_id" id="org_regroupement_id" disabled>
                                        ...
                                        <div class="form-group zone-rurale-field" style="display: none;">
                                            ...
                                            <select class="form-select-modern" name="org_village_id" id="org_village_id" disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-input-modern" name="org_lieu_dit" id="org_lieu_dit" value="{{ old('org_lieu_dit') }}" placeholder="Lieu-dit (optionnel)">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="form-label-modern">Préfecture <span class="required">*</span></label>
                                            <input type="text" class="form-input-modern" name="org_prefecture" id="org_prefecture" value="{{ old('org_prefecture') }}" required placeholder="Préfecture">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="form-label-modern">Sous-Préfecture</label>
                                            <input type="text" class="form-input-modern" name="org_sous_prefecture" id="org_sous_prefecture" value="{{ old('org_sous_prefecture') }}" placeholder="Sous-préfecture (optionnel)">
                                        </div>
                                        
                                        <div class="form-group span-2">
                                            <label class="form-label-modern">Adresse complète du siège social <span class="required">*</span></label>
                                            <input type="text" class="form-input-modern" name="org_adresse" id="org_adresse" value="{{ old('org_adresse') }}" required placeholder="Numéro, rue, bâtiment...">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="form-label-modern">Latitude</label>
                                            <input type="text" class="form-input-modern" name="org_latitude" id="org_latitude" value="{{ old('org_latitude') }}" placeholder="Ex: 0.4162">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="form-label-modern">Longitude</label>
                                            <input type="text" class="form-input-modern" name="org_longitude" id="org_longitude" value="{{ old('org_longitude') }}" placeholder="Ex: 9.4673">
                                        </div>
                                    ...
                                    <div class="section-footer">
                                        <button type="button" class="btn-nav btn-nav-prev" onclick="goToSection('collapseOrganisation')">
                                            <i class="fas fa-arrow-left"></i> Précédent
                                        </button>
                                        <button type="button" class="btn-nav btn-nav-next" onclick="goToSection('collapseFondateurs')">
                                            Suivant <i class="fas fa-arrow-right"></i>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header">
                                <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFondateurs" aria-expanded="false">
                                    <div class="accordion-trigger-content">
                                        <div class="step-icon-box pink"><i class="fas fa-users"></i></div>
                                        <div class="step-text-group">
                                            <div class="step-eyebrow">Étape 5 sur 7</div>
                            ...
                            <div id="collapseFondateurs" class="accordion-collapse collapse" data-bs-parent="#accordionDossier">
                                <div class="accordion-content">
                                    <div class="alert-box warning">
                                        <i class="fas fa-exclamation-triangle fa-lg"></i>
                                        <div><strong>Minimum requis :</strong> <span id="minFondateursText">2</span> fondateur(s) majeur(s)</div>
                                    </div>
                                    ...
                                    <div class="add-member-card">
                                        ...
                                        <div class="add-member-grid">
                                            ...
                                            <input type="text" class="form-input-modern" id="fondateur_nip" placeholder="NIP">
                                            <input type="text" class="form-input-modern" id="fondateur_nom" placeholder="Nom">
                                            <input type="text" class="form-input-modern" id="fondateur_prenom" placeholder="Prénom">
                                    ...
                                    <div class="data-table-wrapper">
                                        <table class="data-table">
                                            ...
                                            <tbody id="fondateursList">
                                                <tr><td colspan="6" class="empty-state"><i class="fas fa-users"></i>Aucun fondateur ajouté</td></tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="section-footer">
                                        <button type="button" class="btn-nav btn-nav-prev" onclick="goToSection('collapseLocalisation')">
                                            <i class="fas fa-arrow-left"></i> Précédent
                                        </button>
                                        <button type="button" class="btn-nav btn-nav-next" onclick="goToSection('collapseAdherents')">
                                            Suivant <i class="fas fa-arrow-right"></i>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header">
                                <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAdherents" aria-expanded="false">
                                    <div class="accordion-trigger-content">
                                        <div class="step-icon-box cyan"><i class="fas fa-user-friends"></i></div>
                                        <div class="step-text-group">
                                            <div class="step-eyebrow">Étape 6 sur 7</div>
                            ...
                            <div id="collapseAdherents" class="accordion-collapse collapse" data-bs-parent="#accordionDossier">
                                <div class="accordion-content">
                                    <div class="alert-box info" id="adherentsRequirements">
                                        <i class="fas fa-info-circle fa-lg"></i>
                                        <div id="adherentsRequirementsText">Section optionnelle pour ce type d'organisation</div>
                                    </div>
                                    ...
                                    <div class="add-member-card cyan">
                                        ...
                                        <div class="add-member-grid adherent-grid">
                                            <input type="text" class="form-input-modern" id="adherent_nip" placeholder="NIP">
                                            <input type="text" class="form-input-modern" id="adherent_nom" placeholder="Nom">
                                            <input type="text" class="form-input-modern" id="adherent_prenom" placeholder="Prénom">
                                            <input type="text" class="form-input-modern" id="adherent_profession" placeholder="Profession">
                                    ...
                                    <div class="data-table-wrapper">
                                        <table class="data-table">
                                            ...
                                            <tbody id="adherentsList">
                                                <tr><td colspan="5" class="empty-state"><i class="fas fa-user-friends"></i>Aucun adhérent ajouté</td></tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="section-footer">
                                        <button type="button" class="btn-nav btn-nav-prev" onclick="goToSection('collapseFondateurs')">
                                            <i class="fas fa-arrow-left"></i> Précédent
                                        </button>
                                        <button type="button" class="btn-nav btn-nav-next" onclick="goToSection('collapseDocuments')">
                                            Suivant <i class="fas fa-arrow-right"></i>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header">
                                <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDocuments" aria-expanded="false">
                                    <div class="accordion-trigger-content">
                                        <div class="step-icon-box orange"><i class="fas fa-file-alt"></i></div>
                                        <div class="step-text-group">
                                            <div class="step-eyebrow">Étape 7 sur 7</div>
                            ...
                            <div id="collapseDocuments" class="accordion-collapse collapse" data-bs-parent="#accordionDossier">
                                <div class="accordion-content">
                                    ...
                                    <div class="section-footer final">
                                        <button type="button" class="btn-nav btn-nav-prev" onclick="goToSection('collapseAdherents')">
                                            <i class="fas fa-arrow-left"></i> Précédent
                                        </button>
...
.orb-1 { width: 500px; height: 500px; background: var(--gabon-green); top: -150px; left: -100px; }
.orb-2 { width: 400px; height: 400px; background: var(--gabon-blue); bottom: -100px; right: -100px; animation-delay: -8s; }
.orb-3 { width: 300px; height: 300px; background: var(--gabon-yellow); top: 50%; left: 50%; transform: translate(-50%, -50%); animation-delay: -16s; opacity: 0.1; }
...
.step.active .step-label { color: var(--gabon-green); font-weight: 600; }
...
.accordion-header { background: transparent; border: none; padding: 0; margin: 0; }
...
.step-icon-box.green { background: linear-gradient(135deg, var(--gabon-green), #00b347); }
.step-icon-box.yellow { background: linear-gradient(135deg, var(--gabon-yellow), #ffa500); }
.step-icon-box.blue { background: linear-gradient(135deg, var(--gabon-blue), #0056b3); }
.step-icon-box.purple { background: linear-gradient(135deg, #8b5cf6, #a78bfa); }
.step-icon-box.pink { background: linear-gradient(135deg, #ec4899, #f472b6); }
.step-icon-box.cyan { background: linear-gradient(135deg, #06b6d4, #22d3ee); }
.step-icon-box.orange { background: linear-gradient(135deg, #f59e0b, #fbbf24); }

.step-text-group { flex: 1; }
.step-eyebrow { font-size: 0.75rem; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.5px; }
...
.zone-selector { margin-bottom: 1.5rem; }
...
.form-textarea-modern { resize: vertical; min-height: 100px; }
...
.type-details span { display: block; }
...
.alert-box.info { background: var(--gabon-blue-light); color: var(--gabon-blue); }
.alert-box.warning { background: #fef3c7; color: #92400e; }
.alert-box.success { background: var(--gabon-green-light); color: var(--gabon-green-dark); }
...
.add-member-card.cyan { background: #e0f2fe; }
...
.add-member-card.cyan .add-member-title { color: #0891b2; }
...
.btn-add:hover { background: var(--gabon-green-dark); transform: translateY(-2px); }
.btn-add.cyan { background: #0891b2; }
.btn-add.cyan:hover { background: #0e7490; }
...
.data-table tbody tr:hover { background: var(--gabon-green-light); }
...
.document-grid { display: grid; gap: 1rem; }
...
.document-card:hover { border-color: var(--gabon-green); }
.document-card.required { border-color: #fca5a5; background: #fef2f2; }
...
.section-footer.final { border-top: 2px solid var(--gabon-green); }
...
@media (max-width: 992px) {
    ...
    .adherent-grid { grid-template-columns: 1fr 1fr; }
}
...
@media (max-width: 768px) {
    ...
    .add-member-grid, .adherent-grid { grid-template-columns: 1fr; }
    .section-footer { flex-direction: column; gap: 1rem; }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateStepper(sectionId) {
        var stepMap = { 'collapseType': 1, 'collapseDeclarant': 2, 'collapseOrganisation': 3, 'collapseLocalisation': 4, 'collapseFondateurs': 5, 'collapseAdherents': 6, 'collapseDocuments': 7 };
        currentStep = stepMap[sectionId] || 1;
        
        var progress = ((currentStep - 1) / 6) * 100;
        document.getElementById('stepperProgress').style.width = progress + '%';
        document.getElementById('globalProgress').style.width = ((currentStep / 7) * 100) + '%';
